    ...
    <div class="col-lg-8">
        ...
        <div class="card-body">
            <form action="{{ route('admin.cars.update', $car->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="nama_mobil">Jenis Kendaraan</label>
                    <select name="jenis_kendaraan" id="jenis_kendaraan" class="form-control">
                        <option {{ $car->jenis_kendaraan == 'mobil' ? 'selected' : null }} value="mobil">Mobil</option>
                        <option {{ $car->jenis_kendaraan == 'motor' ? 'selected' : null }} value="motor">Motor</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="deskripsi" cols="30" rows="5">{{ old('deskripsi', $car->deskripsi) }}</textarea>
                </div>
                <div class="form-group">
